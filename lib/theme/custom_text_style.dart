...
class CustomTextStyles {
  ...
  static TextStyle get bodySmallGray900 => theme.textTheme.bodySmall!.copyWith(
    color: appTheme.gray900,
    fontSize: 12.fSize,
  );
  static TextStyle get bodySmallIndigo20001 =>
      theme.textTheme.bodySmall!.copyWith(
        color: appTheme.indigo20001,
        fontSize: 8.fSize,
      );
  static TextStyle get bodySmallLatoBluegray60001 =>
      theme.textTheme.bodySmall!.lato.copyWith(
        color: appTheme.blueGray60001,
        fontSize: 12.fSize,
      );
  static TextStyle get bodySmallLatoBluegray6000112 =>
      theme.textTheme.bodySmall!.lato.copyWith(
        color: appTheme.blueGray60001,
        fontSize: 12.fSize,
      );
  static TextStyle get bodySmallLatoIndigo20001 =>
      theme.textTheme.bodySmall!.lato.copyWith(
        color: appTheme.indigo20001,
        fontSize: 12.fSize,
      );
  static TextStyle get bodySmallRalewayBluegray60001 =>
      theme.textTheme.bodySmall!.raleway.copyWith(
        color: appTheme.blueGray60001,
        fontSize: 12.fSize,
      );
  static TextStyle get bodySmallRalewayBluegray6000112 =>
      theme.textTheme.bodySmall!.raleway.copyWith(
        color: appTheme.blueGray60001,
        fontSize: 12.fSize,
      );
  static TextStyle get bodySmallRalewayBluegray6000112_1 =>
      theme.textTheme.bodySmall!.raleway.copyWith(
        color: appTheme.blueGray60001,
        fontSize: 12.fSize,
      );
  static TextStyle get bodySmallRalewayBluegray600018 =>
      theme.textTheme.bodySmall!.raleway.copyWith(
        color: appTheme.blueGray60001,
        fontSize: 8.fSize,
      );
  static TextStyle get bodySmallRalewayBluegray80005 =>
      theme.textTheme.bodySmall!.raleway.copyWith(
...
// Label text style
  ...
  static TextStyle get labelLargeIndigo50 =>
      theme.textTheme.labelLarge!.copyWith(
        color: appTheme.indigo50,
        fontWeight: FontWeight.w600,
      );
  static TextStyle get labelLargeLatoBlack900 =>
      theme.textTheme.labelLarge!.lato.copyWith(
        color: appTheme.black900,
        fontWeight: FontWeight.w600,
      );
  static TextStyle get labelLargeLatoDeeppurpleA200 =>
      theme.textTheme.labelLarge!.lato.copyWith(
        color: appTheme.deepPurpleA200,
        fontWeight: FontWeight.w700,
      );
  static TextStyle get labelLargeLatoPrimary =>
      theme.textTheme.labelLarge!.lato.copyWith(
        color: theme.colorScheme.primary,
        fontWeight: FontWeight.w700,
      );
  static TextStyle get labelLargeLatoPrimarySemiBold =>
      theme.textTheme.labelLarge!.lato.copyWith(
        color: theme.colorScheme.primary,
        fontWeight: FontWeight.w600,
      );
  ...
  static TextStyle get labelLargeOnPrimarySemiBold_1 =>
      theme.textTheme.labelLarge!.copyWith(
        color: theme.colorScheme.onPrimary.withValues(
          alpha: 1,
        ),
  ...
  static TextStyle get labelLargeRalewayBluegray60001 =>
      theme.textTheme.labelLarge!.raleway.copyWith(
        color: appTheme.blueGray60001,
      );
  static TextStyle get labelLargeRalewayBluegray800 =>
      theme.textTheme.labelLarge!.raleway.copyWith(
        color: appTheme.blueGray800,
        fontWeight: FontWeight.w700,
      );
  static TextStyle get labelLargeRalewayBluegray80006 =>
      theme.textTheme.labelLarge!.raleway.copyWith(
        color: appTheme.blueGray80006,
      );
  static TextStyle get labelLargeRalewayPrimary =>
      theme.textTheme.labelLarge!.raleway.copyWith(
        color: theme.colorScheme.primary,
        fontWeight: FontWeight.w600,
      );
  static TextStyle get labelLargeTeal900 =>
      theme.textTheme.labelLarge!.copyWith(
  ...
  static TextStyle get labelMediumBluegray60001 =>
      theme.textTheme.labelMedium!.copyWith(
        color: appTheme.blueGray60001,
      );
  static TextStyle get labelMediumBluegray60001Bold =>
      theme.textTheme.labelMedium!.copyWith(
        color: appTheme.blueGray60001,
        fontWeight: FontWeight.w700,
      );
  ...
  static TextStyle get labelMediumBluegray800_1 =>
      theme.textTheme.labelMedium!.copyWith(
        color: appTheme.blueGray800,
      );
  static TextStyle get labelMediumRalewayBluegray60001 =>
