...
import 'bloc/my_bank_information_bloc.dart';
import 'models/my_bank_information_model.dart';

class MyBankInformationScreen extends StatelessWidget {
  const MyBankInformationScreen({Key? key})
      : super(
    key: key,
  );

  static Widget builder(BuildContext context) {
    return BlocProvider<MyBankInformationBloc>(
      create: (context) => MyBankInformationBloc(MyBankInformationState(
        myBankInformationModelObj: MyBankInformationModel(),
      ))
        ..add(MyBankInformationInitialEvent()),
      child: MyBankInformationScreen(),
    );
  }
  ...
  Widget _buildRowsearch(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<MyBankInformationBloc, MyBankInformationState,
