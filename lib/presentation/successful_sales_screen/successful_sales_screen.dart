...
import 'bloc/successful_sales_bloc.dart';
import 'models/successful_sales_model.dart';

// ignore_for_file: must_be_immutable
class SuccessfulSalesScreen extends StatelessWidget {
  SuccessfulSalesScreen({Key? key})
      : super(
    key: key,
  );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SuccessfulSalesBloc>(
      create: (context) => SuccessfulSalesBloc(SuccessfulSalesState(
        successfulSalesModelObj: SuccessfulSalesModel(),
      ))
        ..add(SuccessfulSalesInitialEvent()),
      child: SuccessfulSalesScreen(),
    );
  }
  ...
  Widget _buildRowsearch(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<SuccessfulSalesBloc, SuccessfulSalesState,
  ...
  Widget _buildName(BuildContext context) {
    return BlocSelector<SuccessfulSalesBloc, SuccessfulSalesState,
        TextEditingController?>(
