...
import 'bloc/test_user_three_bloc.dart';
import 'models/test_user_three_model.dart';

// ignore_for_file: must_be_immutable
class TestUserThreeScreen extends StatelessWidget {
  TestUserThreeScreen({Key? key})
      : super(
    key: key,
  );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<TestUserThreeBloc>(
      create: (context) => TestUserThreeBloc(TestUserThreeState(
        testUserThreeModelObj: TestUserThreeModel(),
      ))
        ..add(TestUserThreeInitialEvent()),
      child: TestUserThreeScreen(),
    );
  }
  ...
  Widget _buildWhatsonair(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
  ...
  /// Section Widget
  Widget _buildGroup2416one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2416oneController,
      builder: (context, group2416oneController) {
        return CustomTextFormField(
          controller: group2416oneController,
  ...
  /// Section Widget
  Widget _buildGroup2453one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2453oneController,
      builder: (context, group2453oneController) {
        return CustomTextFormField(
          controller: group2453oneController,
  ...
  /// Section Widget
  Widget _buildGroup2457one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2457oneController,
      builder: (context, group2457oneController) {
        return CustomTextFormField(
          controller: group2457oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2453one(context),
          _buildGroup2457one(context),
          Text(
  ...
  /// Section Widget
  Widget _buildGroup2461one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2461oneController,
      builder: (context, group2461oneController) {
        return CustomTextFormField(
          controller: group2461oneController,
  ...
  /// Section Widget
  Widget _buildGroup2463one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2463oneController,
      builder: (context, group2463oneController) {
        return CustomTextFormField(
          controller: group2463oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2461one(context),
          _buildGroup2463one(context),
  ...
  /// Section Widget
  Widget _buildGroup2474one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2474oneController,
      builder: (context, group2474oneController) {
        return CustomTextFormField(
          controller: group2474oneController,
  ...
  /// Section Widget
  Widget _buildGroup2485one(BuildContext context) {
    return BlocSelector<TestUserThreeBloc, TestUserThreeState,
        TextEditingController?>(
      selector: (state) => state.group2485oneController,
      builder: (context, group2485oneController) {
        return CustomTextFormField(
          controller: group2485oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2474one(context),
          _buildAboutone(context),
          _buildGroup2485one(context),
