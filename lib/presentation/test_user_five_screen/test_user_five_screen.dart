...
import 'bloc/test_user_five_bloc.dart';
import 'models/test_user_five_model.dart';

// ignore_for_file: must_be_immutable
class TestUserFiveScreen extends StatelessWidget {
  TestUserFiveScreen({Key? key})
      : super(
    key: key,
  );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<TestUserFiveBloc>(
      create: (context) => TestUserFiveBloc(TestUserFiveState(
        testUserFiveModelObj: TestUserFiveModel(),
      ))
        ..add(TestUserFiveInitialEvent()),
      child: TestUserFiveScreen(),
    );
  }
  ...
  Widget _buildWhatsonair(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
  ...
  /// Section Widget
  Widget _buildGroup2311one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2311oneController,
      builder: (context, group2311oneController) {
        return CustomTextFormField(
          controller: group2311oneController,
  ...
  /// Section Widget
  Widget _buildGroup2371one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2371oneController,
      builder: (context, group2371oneController) {
        return CustomTextFormField(
          controller: group2371oneController,
  ...
  /// Section Widget
  Widget _buildGroup2373one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2373oneController,
      builder: (context, group2373oneController) {
        return CustomTextFormField(
          controller: group2373oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2371one(context),
          _buildGroup2373one(context),
          Text(
  ...
  /// Section Widget
  Widget _buildGroup2375one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2375oneController,
      builder: (context, group2375oneController) {
        return CustomTextFormField(
          controller: group2375oneController,
  ...
  /// Section Widget
  Widget _buildGroup2377one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2377oneController,
      builder: (context, group2377oneController) {
        return CustomTextFormField(
          controller: group2377oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2375one(context),
          _buildGroup2377one(context),
  ...
  /// Section Widget
  Widget _buildGroup2383one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2383oneController,
      builder: (context, group2383oneController) {
        return CustomTextFormField(
          controller: group2383oneController,
  ...
  /// Section Widget
  Widget _buildGroup2387one(BuildContext context) {
    return BlocSelector<TestUserFiveBloc, TestUserFiveState,
        TextEditingController?>(
      selector: (state) => state.group2387oneController,
      builder: (context, group2387oneController) {
        return CustomTextFormField(
          controller: group2387oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2383one(context),
          _buildAboutone(context),
          _buildGroup2387one(context),
