...
import 'bloc/test_user_one_bloc.dart';
import 'models/test_user_one_model.dart';

// ignore_for_file: must_be_immutable
class TestUserOneScreen extends StatelessWidget {
  TestUserOneScreen({Key? key})
      : super(
    key: key,
  );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<TestUserOneBloc>(
      create: (context) => TestUserOneBloc(TestUserOneState(
        testUserOneModelObj: TestUserOneModel(),
      ))
        ..add(TestUserOneInitialEvent()),
      child: TestUserOneScreen(),
    );
  }
  ...
  Widget _buildWhatsonair(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
  ...
  /// Section Widget
  Widget _buildGroup2332one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2332oneController,
      builder: (context, group2332oneController) {
        return CustomTextFormField(
          controller: group2332oneController,
  ...
  /// Section Widget
  Widget _buildGroup2355one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2355oneController,
      builder: (context, group2355oneController) {
        return CustomTextFormField(
          controller: group2355oneController,
  ...
  /// Section Widget
  Widget _buildGroup2358one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2358oneController,
      builder: (context, group2358oneController) {
        return CustomTextFormField(
          controller: group2358oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2355one(context),
          _buildGroup2358one(context),
          Text(
  ...
  /// Section Widget
  Widget _buildGroup2361one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2361oneController,
      builder: (context, group2361oneController) {
        return CustomTextFormField(
          controller: group2361oneController,
  ...
  /// Section Widget
  Widget _buildGroup2428one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2428oneController,
      builder: (context, group2428oneController) {
        return CustomTextFormField(
          controller: group2428oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2361one(context),
          _buildGroup2428one(context),
  ...
  /// Section Widget
  Widget _buildGroup2446one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2446oneController,
      builder: (context, group2446oneController) {
        return CustomTextFormField(
          controller: group2446oneController,
  ...
  /// Section Widget
  Widget _buildGroup2456one(BuildContext context) {
    return BlocSelector<TestUserOneBloc, TestUserOneState,
        TextEditingController?>(
      selector: (state) => state.group2456oneController,
      builder: (context, group2456oneController) {
        return CustomTextFormField(
          controller: group2456oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2446one(context),
          _buildAboutone(context),
          _buildGroup2456one(context),
