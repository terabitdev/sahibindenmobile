...
import 'bloc/ad_management_not_on_air_bloc.dart';
import 'models/ad_management_not_on_air_model.dart';

class AdManagementNotOnAirScreen extends StatelessWidget {
  const AdManagementNotOnAirScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<AdManagementNotOnAirBloc>(
      create: (context) => AdManagementNotOnAirBloc(AdManagementNotOnAirState(
        adManagementNotOnAirModelObj: AdManagementNotOnAirModel(),
      ))..add(AdManagementNotOnAirInitialEvent()),
      child: AdManagementNotOnAirScreen(),
    );
  }
  ...
  Widget _buildRowsearch(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<AdManagementNotOnAirBloc,
                AdManagementNotOnAirState, TextEditingController?>(
  ...
  Widget _buildFormtextfill(BuildContext context) {
    return BlocSelector<AdManagementNotOnAirBloc, AdManagementNotOnAirState,
  ...
  /// current [adManagementNotOnAirModelObj] object if the user selects a valid date.
  ///
  /// This function returns a `Future` that completes with `void`.
  Future<void> onTapDate(BuildContext context) async {
    var initialState = BlocProvider.of<AdManagementNotOnAirBloc>(context).state;
    ...
    if (dateTime != null) {
      context.read<AdManagementNotOnAirBloc>().add(ChangeDateEvent(date: dateTime));
