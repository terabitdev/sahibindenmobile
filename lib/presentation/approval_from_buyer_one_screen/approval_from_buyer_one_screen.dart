...
import 'bloc/approval_from_buyer_one_bloc.dart';
import 'models/approval_from_buyer_one_model.dart';

// ignore_for_file: must_be_immutable
class ApprovalFromBuyerOneScreen extends StatelessWidget {
  ApprovalFromBuyerOneScreen({Key? key})
      : super(
          key: key,
        );
  GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  static Widget builder(BuildContext context) {
    return BlocProvider<ApprovalFromBuyerOneBloc>(
      create: (context) => ApprovalFromBuyerOneBloc(ApprovalFromBuyerOneState(
        approvalFromBuyerOneModelObj: ApprovalFromBuyerOneModel(),
      ))
        ..add(ApprovalFromBuyerOneInitialEvent()),
      child: ApprovalFromBuyerOneScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppbar(BuildContext context) {
    return CustomAppBar(
      ...
      title: AppbarSubtitle(
        text: "msg_approval_from_buyer".tr,
      ),
  ...
  Widget _buildRowsearch(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<ApprovalFromBuyerOneBloc,
                ApprovalFromBuyerOneState, TextEditingController?>(
  ...
  Widget _buildName(BuildContext context) {
    return BlocSelector<ApprovalFromBuyerOneBloc, ApprovalFromBuyerOneState,
