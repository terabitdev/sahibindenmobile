...
import 'bloc/what_i_sold_with_yepy_bloc.dart';
import 'models/what_i_sold_with_yepy_model.dart';

class WhatISoldWithYepyScreen extends StatelessWidget {
  const WhatISoldWithYepyScreen({Key? key})
      : super(
    key: key,
  );

  static Widget builder(BuildContext context) {
    return BlocProvider<WhatISoldWithYepyBloc>(
      create: (context) => WhatISoldWithYepyBloc(WhatISoldWithYepyState(
        whatISoldWithYepyModelObj: WhatISoldWithYepyModel(),
      ))
        ..add(WhatISoldWithYepyInitialEvent()),
      child: WhatISoldWithYepyScreen(),
    );
  }
  ...
  Widget _buildRowsearch(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<WhatISoldWithYepyBloc, WhatISoldWithYepyState,
