...
import 'bloc/test_user_two_bloc.dart';
import 'models/test_user_two_model.dart';

// ignore_for_file: must_be_immutable
class TestUserTwoScreen extends StatelessWidget {
  TestUserTwoScreen({Key? key})
      : super(
    key: key,
  );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<TestUserTwoBloc>(
      create: (context) => TestUserTwoBloc(TestUserTwoState(
        testUserTwoModelObj: TestUserTwoModel(),
      ))
        ..add(TestUserTwoInitialEvent()),
      child: TestUserTwoScreen(),
    );
  }
  ...
  Widget _buildWhatsonair(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
  ...
  /// Section Widget
  Widget _buildGroup2404one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2404oneController,
      builder: (context, group2404oneController) {
        return CustomTextFormField(
          controller: group2404oneController,
  ...
  /// Section Widget
  Widget _buildGroup2479one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2479oneController,
      builder: (context, group2479oneController) {
        return CustomTextFormField(
          controller: group2479oneController,
  ...
  /// Section Widget
  Widget _buildGroup2484one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2484oneController,
      builder: (context, group2484oneController) {
        return CustomTextFormField(
          controller: group2484oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2479one(context),
          _buildGroup2484one(context),
          Text(
  ...
  /// Section Widget
  Widget _buildGroup2488one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2488oneController,
      builder: (context, group2488oneController) {
        return CustomTextFormField(
          controller: group2488oneController,
  ...
  /// Section Widget
  Widget _buildGroup2491one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2491oneController,
      builder: (context, group2491oneController) {
        return CustomTextFormField(
          controller: group2491oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2488one(context),
          _buildGroup2491one(context),
  ...
  /// Section Widget
  Widget _buildGroup2497one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2497oneController,
      builder: (context, group2497oneController) {
        return CustomTextFormField(
          controller: group2497oneController,
  ...
  /// Section Widget
  Widget _buildGroup2501one(BuildContext context) {
    return BlocSelector<TestUserTwoBloc, TestUserTwoState,
        TextEditingController?>(
      selector: (state) => state.group2501oneController,
      builder: (context, group2501oneController) {
        return CustomTextFormField(
          controller: group2501oneController,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGroup2497one(context),
          _buildAboutone(context),
          _buildGroup2501one(context),
