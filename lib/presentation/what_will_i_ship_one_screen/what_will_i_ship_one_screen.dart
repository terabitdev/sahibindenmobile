...
import 'bloc/what_will_i_ship_one_bloc.dart';
import 'models/what_will_i_ship_one_model.dart';

// ignore_for_file: must_be_immutable
class WhatWillIShipOneScreen extends StatelessWidget {
  WhatWillIShipOneScreen({Key? key})
      : super(
    key: key,
  );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<WhatWillIShipOneBloc>(
      create: (context) => WhatWillIShipOneBloc(WhatWillIShipOneState(
        whatWillIShipOneModelObj: WhatWillIShipOneModel(),
      ))
        ..add(WhatWillIShipOneInitialEvent()),
      child: WhatWillIShipOneScreen(),
    );
  }
  ...
  Widget _buildRowsearch(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<WhatWillIShipOneBloc, WhatWillIShipOneState,
  ...
  Widget _buildName(BuildContext context) {
    return BlocSelector<WhatWillIShipOneBloc, WhatWillIShipOneState,
        TextEditingController?>(
