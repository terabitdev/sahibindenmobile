...
/// This class defines the variables used in the [while_buying_vehicle_comparison_screen],
/// and is typically used to hold data that is passed between different parts of the application.

// ignore_for_file: must_be_immutable
class WhileBuyingVehicleComparisonModel extends Equatable {
  ...
  WhileBuyingVehicleComparisonModel copyWith({
    List<SelectionPopupModel>? dropdownItemList,
    List<SelectionPopupModel>? dropdownItemList1,
    List<SelectionPopupModel>? dropdownItemList2,
    List<SelectionPopupModel>? dropdownItemList3,
    ...
    return WhileBuyingVehicleComparisonModel(
